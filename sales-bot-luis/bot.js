...
class OISalesBot {
     ...
     */
    constructor(luisApplication, luisApplicationES, luisPredictionOptions, conversationState, userState) {
        ...
        this.dialogs.add(new TopMenu(this.luisApplication, this.luisApplicationES, this.luisPredictionOptions, conversationState, this.userProfileAccessor, this.conversationAccessor));
    }
        ...
        // If Genex should ever switch to a Teams, Skype, or Slack type channel, then this logic will need to be modified.
            ...
            if (turnContext.activity && turnContext.activity.membersAdded) {
                ...
                if (conversationMembers[0].id !== turnContext.activity.recipient.id) {
                    ...
                    await dc.context.sendActivity(`Hi! I’m Brian, the O-I Sales Helper bot`);
                }
            }
        }
        else {
...
module.exports.OISalesBot = OISalesBot;